...
public class KubernetesJobClusterEntrypoint extends JobClusterEntrypoint {
	...
	public KubernetesJobClusterEntrypoint(FlinkKubernetesOptions options) {
	...
	protected DispatcherResourceManagerComponentFactory<?> createDispatcherResourceManagerComponentFactory(Configuration configuration) {
		return new JobDispatcherResourceManagerComponentFactory(new KubernetesResourceManagerFactory(this.options),
